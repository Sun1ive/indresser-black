<template>
  <v-container class="clothesBG" fluid>
    ...
    <v-dialog ref="dialog" max-width="85vh" v-model="isActive">
        ...
        items: [
          {
            ...
            desc: `Фасон: приталенный силуэт Цвет: розовый, черный Длина: на уровне колена Карманы: нет Рукав: крылышко Платье не на подкладке Состав: вискоза 45%, полиэстер 53%, спандекс 2%`,
            gallery: [
          ...
          },
          {
            ...
            desc: `Фасон: платье футляр полуприлегающего силуэта Цвет: розово-бордовое, бежево-черное Особенности: Кокетка по полочке и спине. Со шлицей Длина : ниже колена Карманы: есть Платье без подкладки Состав: вискоза 45%, полиэстр 53%, спандекс 2%`,
            gallery: [
          ...
          {
            title: `Для тех, кто выберает стильные и удобные платья в cтиле Casual`,
            desc: `Фасон: платье трапеция с подрезами Цвет: бежевый, синий Длина: выше колена Карманы: в боковых швах Платье на подкладке Состав: вискоза 45%, полиэстер 53%, спандекс 2%`,
            gallery: [
          ...
          {
            title: `Для тех, кто живет в ритме города и не беспокоится по мелочам!`,
            desc: `Фасон: платье полуприлегающего силуэта Цвет: красный, черный Особенности: по спинке молния Длина: до колен Карманы: нет Платье без подкладки Состав: вискоза 20%, полиэстер 80%`,
            gallery: [
